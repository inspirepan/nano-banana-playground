...
export const agentChatMessages: MessageDictionary = {
  ...
  'agentChat.options.thinking': { 'zh-CN': '深度思考', en: 'Thinking depth' },
  'agentChat.thinking.label': { 'zh-CN': 'Thinking', en: 'Thinking' },
  ...
  'agentChat.thinking.high': { 'zh-CN': '超高', en: 'Very high' },
  ...
  'agentChat.taskStatus.canceled': { 'zh-CN': '已取消', en: 'Canceled' },
  ...
  'agentChat.system.imageCanceled': { 'zh-CN': '生成任务已取消', en: 'Image task was canceled' },
  'agentChat.system.imageCanceledWithCompleted': {
    'zh-CN': '生成任务已取消，已完成 {count} 张',
    en: 'Image task was canceled with {count} completed',
  },
