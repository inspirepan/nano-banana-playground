...
export function DrawingSkillStarters({
  ...
  return (
    <div className="mx-auto w-full max-w-[960px]">
      ...
      <div
        className="scroll-fade-x grid auto-cols-[140px] grid-flow-col grid-rows-1 snap-x gap-[2px] overflow-x-auto px-7 py-1.5 scroll-pl-7 [--scroll-fade-end-size:3rem] [--scroll-fade-start-size:3rem] sm:auto-cols-[152px] [&::-webkit-scrollbar]:hidden"
