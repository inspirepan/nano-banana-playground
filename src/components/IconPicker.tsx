...
export function IconPicker({ value, onChange }: Props) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {open && (
        <div className="popover-pop absolute right-0 z-30 mt-1 w-[320px] origin-top-right rounded-[var(--radius-md)] bg-(--color-surface) p-2 shadow-[0_0_0_1px_var(--ring-edge-elevated),var(--shadow-float)]">
